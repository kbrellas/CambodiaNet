...
namespace Timesheets2.Data.Migrations
{
    ...
    [Migration("20191201143514_InitialDB5")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Timesheets2.Models.TimesheetProject", b =>
                {
                    b.Property<long>("ProjectId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("ProjectId", "TimesheetId");
            ...
            modelBuilder.Entity("Timesheets2.Models.TimesheetProject", b =>
                {
                    ...
                    b.HasOne("Timesheets2.Models.Timesheet", "Timesheet")
                        .WithOne("Project")
                        .HasForeignKey("Timesheets2.Models.TimesheetProject", "TimesheetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
